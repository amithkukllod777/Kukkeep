...
const Map<String, Map<String, String>> _notif = {
  'en': {'notification_sound': 'Notification sound', 'sound_settings': 'Sound & tone', 'test_reminder': 'Send a test reminder', 'test_reminder_sent': 'Test reminder in ~5 seconds', 'fix_reminders': 'Reminders not arriving?'},
  'hi': {'notification_sound': 'नोटिफ़िकेशन ध्वनि', 'sound_settings': 'ध्वनि और टोन', 'test_reminder': 'टेस्ट रिमाइंडर भेजें', 'test_reminder_sent': '~5 सेकंड में टेस्ट रिमाइंडर', 'fix_reminders': 'रिमाइंडर नहीं आ रहे?'},
